<div class="tools">
  <div class="tools__container">
    <div class="tools__section tools__section--left">
      <a href="<?= url('/') ?>" class="home__link" title="Back to Home"><i class="fas fa-arrow-left"></i> <span class="home__link__label">Home</span></a>
    </div>
    ...
    <div class="navigation__panel navigation__panel--info clearfix">
      <div class="navigation__column navigation__column--left span-11 append-1">
        ...
        <ul class="navigation__list">
          <li class="navigation__item">
            <a class="navigation__link" href="<?= url('/about') ?>">
          ...
          <li class="navigation__item">
            <a class="navigation__link" href="<?= url('/vita') ?>">
          ...
          <li class="navigation__item">
            <a class="navigation__link" href="<?= url('/events') ?>">
      ...
      <div class="navigation__column navigation__column--right span-11 prepend-1 last">
        ...
        <h3 class="navigation__heading section-title">Content</h3>
         <ul class="navigation__list">
          <li class="navigation__item">
            <a class="navigation__link" href="<?= url('/notes') ?>">
          ...
          <li class="navigation__item">
            <a class="navigation__link" href="<?= url('/talks') ?>">
          ...
          <li class="navigation__item">
            <a class="navigation__link" href="<?= url('/letters') ?>">
