...
<head>
  ...
  <meta name="Description" content="<?= excerpt($page->text(), 140) ?>" />
  ...
  <meta property="og:description" content="<?= excerpt($page->text(), 140) ?>" />
  <meta property="og:url" content="<?= html($site->url()) ?>" />
  <!-- ——————————————————————————————————————————————————————————————————— IMAGE -->
  <link rel="image_src" href="assets/img/logos/benjaminwiederkehr_notes_logo_dark.png" />
  <meta property="og:image" content="assets/img/logos/benjaminwiederkehr_notes_logo_dark.png" />
  <!-- ——————————————————————————————————————————————————————————————————— FAVICON -->
